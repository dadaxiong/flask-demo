...
var xtqiniu = {
	'setUp': function(args) {
		var domain = 'http://opihph4wd.bkt.clouddn.com/';
		var params = {
			...
			uptoken_url: '/post/qiniu_token/', //ajax请求token的url
            ...
            filters: {
                mime_types :[
                    ...
                    {title:'Video files',extensions: 'flv,qsv,mpg,mpeg,avi,wmv,mov,asf,rm,rmvb,mkv,m4v,mp4'}
                ]
            },
			log_level: 5, //log级别
			init: {
